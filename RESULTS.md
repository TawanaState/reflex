...
**Updated 2026-09-23 (completed matched 500-request benchmark).** The current evidence is the paired same-checkpoint experiment below. Historical v1/v2 and earlier unmatched probes remain documented afterward; their old latency comparisons are superseded by the paired result.
